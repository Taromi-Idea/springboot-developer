...
import com.taromi.springbootdeveloper.dto.ArticleListViewResponse;
import com.taromi.springbootdeveloper.dto.ArticleViewResponse;
...
public class BlogViewController {
    ...
    // id 키를 가진 쿼리 파라미터의 값을 id 변수에 매핑 (id는 필수는 아님)
